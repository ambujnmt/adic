...
export default function AdvancedTechnology() {
    return (
        <>
            <section className="bg-[#0B1F3A] xl:py-[70px] lg:py-[70px] py-[40px]">
                    ...
                    <div className="grid grid-cols-12 gap-4 items-center">
                        ...
                        <div className="xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                            <div className="xl:pl-[50px] lg:pl-[50px] md:pl-[30px] pl-[0px]">
                                <h3 className="text-white xl:text-[44px] lg:text-[44px] text-[30px] xl:leading-[50px] lg:leading-[50px] leading-[35px] font-semibold mb-5">Advanced Technology for More Precise Care</h3>
                                ...
                                Clinical research has shown that Yomi is the most accurate modality for implant surgery.</p>
