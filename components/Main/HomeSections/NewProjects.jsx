...
export default function NewProjects() {
    return (
        <section className="container py-10 mt-[60px]">
            {/* Header */}
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-6">
                ...
                <Link href="#">
                    <h6 className="text-[var(--text-color3)] text-[15px] font-semibold flex items-center hover:text-[var(--primary-color)]">Explore New Projects &nbsp; <FaArrowRight /></h6>
                </Link>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
                ...
                <div className="group cursor-pointer">
                    <div className="overflow-hidden rounded-tl-lg rounded-tr-lg mb-3">
                        <img
                    ...
                    <p className="text-[11px] font-semibold text-[var(--text-color2)] mb-1 uppercase">
                        Godrej Properties
                    </p>
                    ...
                    <p className="text-[14px] font-semibold text-[var(--primary-color)] mt-2">
                        ₹2.45 Cr onwards
                    </p>
                    <p className="text-[11px] text-[var(--text-color2)] mt-0.5">2 &amp; 3 BHK Apartments</p>
                </div>
                ...
                <div className="group cursor-pointer">
                    ...
                    <p className="text-[11px] text-[var(--text-color2)] mt-0.5">Ultra Luxury 4 BHK</p>
                </div>
                ...
                <div className="group cursor-pointer">
                    ...
                    <p className="text-[11px] text-[var(--text-color2)] mt-0.5">Villas & Apartments</p>
                </div>
                ...
                <div className="group cursor-pointer">
                    ...
                    <p className="text-[11px] text-[var(--text-color2)] mt-0.5">Premium 2 BHK</p>
                </div>
            </div>
        </section>
    );
