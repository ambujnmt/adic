    ...
    return (
        <>  
            <section className="container"> 
                <div className="mt-[60px] mx-auto bg-white border border-gray-200 rounded-2xl shadow-sm px-6 py-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-0 lg:divide-x divide-gray-200">
                        ...
                        <div className="flex items-center gap-3 lg:px-4 lg:first:pl-0">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] text-[#252527] mt-0.5">User Friendly Filters</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 lg:px-4">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] text-[#252527] mt-0.5">100% Genuine Properties</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 lg:px-4">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] text-[#252527] mt-0.5">Get best deals</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 lg:px-4">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] text-[#252527] mt-0.5">Consultation &amp; Assistance</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 lg:px-4 lg:last:pr-0">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] text-[#252527] mt-0.5">Verified Documentation</p>
                            </div>
                        </div>
                    </div>
                </div>
